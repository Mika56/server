...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.FileAction({
  ...
  iconSvgInline: () => {
    return _mdi_svg_svg_trash_can_svg_raw__WEBPACK_IMPORTED_MODULE_4__;
  },
  enabled(nodes) {
...
/* harmony import */ var _mdi_svg_svg_folder_move_svg_raw__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @mdi/svg/svg/folder-move.svg?raw */ "./node_modules/@mdi/svg/svg/folder-move.svg?raw");
/* harmony import */ var _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./moveOrCopyActionUtils */ "./apps/files/src/actions/moveOrCopyActionUtils.ts");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../logger */ "./apps/files/src/logger.js");
/* harmony import */ var _utils_fileUtils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/fileUtils */ "./apps/files/src/utils/fileUtils.ts");
/**
 * @copyright Copyright (c) 2023 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
...
const getActionForNodes = nodes => {
  if ((0,_moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.canMove)(nodes)) {
    if ((0,_moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.canCopy)(nodes)) {
      return _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE_OR_COPY;
    }
    return _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE;
  }
  // Assuming we can copy as the enabled checks for copy permissions
  return _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.COPY;
};
/**
...
const handleCopyMoveNodeTo = async function (node, destination, method) {
  ...
  if (method === _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE && node.dirname === destination.path) {
  ...
  // Set loading state
  vue__WEBPACK_IMPORTED_MODULE_11__["default"].set(node, 'status', _nextcloud_files__WEBPACK_IMPORTED_MODULE_4__.NodeStatus.LOADING);
  const queue = (0,_moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.getQueue)();
  return await queue.add(async () => {
    ...
    try {
      ...
      if (method === _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.COPY) {
        let target = node.basename;
        // If we do not allow overwriting then find an unique name
        if (!overwrite) {
          const otherNodes = await client.getDirectoryContents(destinationPath);
          target = (0,_utils_fileUtils__WEBPACK_IMPORTED_MODULE_10__.getUniqueName)(node.basename, otherNodes.map(n => n.basename), copySuffix);
        }
      ...
      if (error instanceof axios__WEBPACK_IMPORTED_MODULE_12__.AxiosError) {
        if (error?.response?.status === 412) {
          ...
          throw new Error((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'The files is locked'));
      ...
      _logger__WEBPACK_IMPORTED_MODULE_9__["default"].debug(error);
      throw new Error();
    } finally {
      vue__WEBPACK_IMPORTED_MODULE_11__["default"].set(node, 'status', undefined);
    }
  });
};
/**
...
const openFilePickerForAction = async function (action) {
  ...
  const filePicker = (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.getFilePickerBuilder)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'Choose destination')).allowDirectories(true).setFilter(n => {
    ...
    return (n.permissions & _nextcloud_files__WEBPACK_IMPORTED_MODULE_4__.Permission.CREATE) !== 0
  ...
  return new Promise((resolve, reject) => {
    filePicker.setButtonFactory((_selection, path) => {
      ...
      if (action === _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.COPY || action === _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE_OR_COPY) {
        buttons.push({
          ...
          async callback(destination) {
            resolve({
              ...
              action: _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.COPY
            });
          }
        });
      }
      ...
      if (action === _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE || action === _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE_OR_COPY) {
        buttons.push({
          ...
          type: action === _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE ? 'primary' : 'secondary',
          icon: _mdi_svg_svg_folder_move_svg_raw__WEBPACK_IMPORTED_MODULE_7__,
          async callback(destination) {
            resolve({
              destination: destination[0],
              action: _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE
            });
          }
        });
      }
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_4__.FileAction({
  ...
  displayName(nodes) {
    switch (getActionForNodes(nodes)) {
      case _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'Move');
      case _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.COPY:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'Copy');
      case _moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.MoveCopyAction.MOVE_OR_COPY:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'Move or copy');
    }
  },
  iconSvgInline: () => _mdi_svg_svg_folder_move_svg_raw__WEBPACK_IMPORTED_MODULE_7__,
  enabled(nodes) {
    // We only support moving/copying files within the user folder
    if (!nodes.every(node => node.root?.startsWith('/files/'))) {
      return false;
    }
    return nodes.length > 0 && ((0,_moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.canMove)(nodes) || (0,_moveOrCopyActionUtils__WEBPACK_IMPORTED_MODULE_8__.canCopy)(nodes));
  },
  async exec(node, view, dir) {
    ...
    try {
      ...
      _logger__WEBPACK_IMPORTED_MODULE_9__["default"].error(e);
      return false;
    }
    try {
  ...
  async execBatch(nodes, view, dir) {
    ...
    const promises = nodes.map(async node => {
      try {
        ...
        _logger__WEBPACK_IMPORTED_MODULE_9__["default"].error(`Failed to ${result.action} node`, {
          node,
          error
        });
        return false;
...
/* harmony import */ var _utils_fileUtils_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils/fileUtils.ts */ "./apps/files/src/utils/fileUtils.ts");
...
logger.debug('Templates providers', {
  templates
});
...
if (!templatesPath) {
  ...
  (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.addNewFileMenuEntry)({
    ...
    handler(context, content) {
      ...
      const name = (0,_utils_fileUtils_ts__WEBPACK_IMPORTED_MODULE_10__.getUniqueName)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('files', 'Templates'), contentNames);
...
templates.forEach((provider, index) => {
  (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.addNewFileMenuEntry)({
    ...
    handler(context, content) {
      // Check for conflicts
      const contentNames = content.map(node => node.basename);
      const name = (0,_utils_fileUtils_ts__WEBPACK_IMPORTED_MODULE_10__.getUniqueName)(provider.label + provider.extension, contentNames);
      // Create the file
...
/* harmony import */ var _utils_fileUtils_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/fileUtils.ts */ "./apps/files/src/utils/fileUtils.ts");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../logger */ "./apps/files/src/logger.js");
...
const entry = {
  ...
  async handler(context, content) {
    const contentNames = content.map(node => node.basename);
    const name = (0,_utils_fileUtils_ts__WEBPACK_IMPORTED_MODULE_8__.getUniqueName)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'New folder'), contentNames);
    const {
      fileid,
      source
...
const getContents = async function () {
  ...
  return {
    ...
    contents: contents.map(r => (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.davResultToNode)(r))
  };
};
...
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @nextcloud/dialogs */ "./node_modules/@nextcloud/dialogs/dist/index.mjs");
/* harmony import */ var _nextcloud_vue_dist_Components_NcEmptyContent_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcEmptyContent.js */ "../nextcloud-vue/dist/Components/NcEmptyContent.mjs");
/* harmony import */ var _nextcloud_vue_dist_Components_NcModal_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcModal.js */ "../nextcloud-vue/dist/Components/NcModal.mjs");
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20height=%2716%27%20width=%2716%27%3e%3cpath%20d=%27M14%2012.3L12.3%2014%208%209.7%203.7%2014%202%2012.3%206.3%208%202%203.7%203.7%202%208%206.3%2012.3%202%2014%203.7%209.7%208z%27/%3e%3c/svg%3e */ "data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20height=%2716%27%20width=%2716%27%3e%3cpath%20d=%27M14%2012.3L12.3%2014%208%209.7%203.7%2014%202%2012.3%206.3%208%202%203.7%203.7%202%208%206.3%2012.3%202%2014%203.7%209.7%208z%27/%3e%3c/svg%3e"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20height=%2716%27%20width=%2716%27%3e%3cpath%20d=%27M14%2012.3L12.3%2014%208%209.7%203.7%2014%202%2012.3%206.3%208%202%203.7%203.7%202%208%206.3%2012.3%202%2014%203.7%209.7%208z%27%20style=%27fill-opacity:1;fill:%23ffffff%27/%3e%3c/svg%3e */ "data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20height=%2716%27%20width=%2716%27%3e%3cpath%20d=%27M14%2012.3L12.3%2014%208%209.7%203.7%2014%202%2012.3%206.3%208%202%203.7%203.7%202%208%206.3%2012.3%202%2014%203.7%209.7%208z%27%20style=%27fill-opacity:1;fill:%23ffffff%27/%3e%3c/svg%3e"), __webpack_require__.b);
...
/******/ })()
;
//# sourceMappingURL=files-init.js.map?v=aa94b12e232f368a3651